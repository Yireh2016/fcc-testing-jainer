...
// -----------------------------------------------------------------------------
  ...
  suite('Comparisons', function() {
    ...
    test('#approximately', function() {
      assert.approximately(weirdNumbers(0.5) , 1, 0.5 );//(1 + delta - Math.random()) 1.5 - 0 y 1.5 - 1 es 1.5 a 0.5
      assert.approximately(weirdNumbers(0.2) , 1, 0.8 );//1.2 y 0.2  0.2 y 0.8
    });
  });
...
// -----------------------------------------------------------------------------
  ...
  suite('Strings', function(){
    ...
    test('#isNotString, #isNotString', function() {
